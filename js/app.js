...
const FALLBACK_IMAGE = "https://images.unsplash.com/photo-1558981403-c5f9899a28bc?auto=format&fit=crop&w=800&q=80";

const products = [
  {
    id: "nm-01", name: "Nova Moto Expedition 38L Aluminum Panniers (Pair)", category: "luggage", categoryLabel: "Touring Luggage",
    price: 64500, rating: 4.9, reviewsCount: 38, badge: "Bestseller", badgeColor: "bg-blue-600",
    image: "https://images.unsplash.com/photo-1558981403-c5f9899a28bc?auto=format&fit=crop&w=800&q=80",
    description: "Engineered for harsh terrain and trans-continental expeditions. Crafted from 2mm aircraft-grade aluminum with stainless steel latches.",
    ...
    sizes: ["Standard 38L+38L", "Heavy-Duty 45L+45L (+₨ 6,000)"], inStock: true
  },
  {
    id: "nm-02", name: "Trans-Continental 4-Season All-Weather Riding Jacket", category: "suits", categoryLabel: "Riding Suits",
    price: 36000, rating: 5.0, reviewsCount: 52, badge: "CE-Level 2", badgeColor: "bg-emerald-600",
    image: "https://images.unsplash.com/photo-1558981806-ec527fa84c39?auto=format&fit=crop&w=800&q=80",
    description: "Built for monsoon downpours, desert heat, and freezing mountain passes. Comes with removable thermal liner and certified D3O armor.",
    ...
    sizes: ["M", "L", "XL", "2XL", "3XL"], inStock: true
  },
  {
    id: "nm-03", name: "Nova Moto 50L Heavy-Duty Waterproof Dry Duffle Bag", category: "luggage", categoryLabel: "Touring Luggage",
    price: 14800, rating: 4.8, reviewsCount: 64, badge: "100% Waterproof", badgeColor: "bg-cyan-600",
    ...
    sizes: ["50 Liters", "65 Liters (+₨ 2,500)"], inStock: true
  },
  {
    id: "nm-04", name: "Nova Tourer Dual-Sport Carbon-Hybrid Adventure Helmet", category: "helmets", categoryLabel: "Helmets & Tech",
    price: 42000, rating: 4.9, reviewsCount: 29, badge: "ECE 22.06", badgeColor: "bg-purple-600",
    ...
    sizes: ["M (57-58cm)", "L (59-60cm)", "XL (61-62cm)"], inStock: true
  },
  {
    id: "nm-05", name: "Apex Adventure Tourer Waterproof Riding Pants", category: "suits", categoryLabel: "Riding Suits",
    price: 24500, rating: 4.7, reviewsCount: 31, badge: "Weatherproof", badgeColor: "bg-slate-700",
    image: "https://images.unsplash.com/photo-1558981420-87aa9dad1c89?auto=format&fit=crop&w=800&q=80",
    description: "Engineered to zip seamlessly into the Trans-Continental jacket or worn standalone. Flexible stretch accordion panels around knees and waist.",
    ...
    sizes: ["30", "32", "34", "36", "38"], inStock: true
  },
  {
    id: "nm-06", name: "Terra-Track CE Adventure Waterproof Touring Boots", category: "boots", categoryLabel: "Gloves & Boots",
    price: 32000, rating: 4.9, reviewsCount: 44, badge: "CE Certified", badgeColor: "bg-emerald-600",
    image: "https://images.unsplash.com/photo-1542282088-72c9c27ed0cd?auto=format&fit=crop&w=800&q=80",
    description: "Rugged oiled full-grain leather boots designed for unpaved mountain roads and endless asphalt. Features molded TPU shin and ankle armor.",
    ...
    sizes: ["EU 41", "EU 42", "EU 43", "EU 44", "EU 45"], inStock: true
  },
  {
    id: "nm-07", name: "Karakoram Arctic Tourer Waterproof Winter Gloves", category: "boots", categoryLabel: "Gloves & Boots",
    price: 11500, rating: 4.8, reviewsCount: 67, badge: "Thermal -10°C", badgeColor: "bg-blue-700",
    image: "https://images.unsplash.com/photo-1558980394-4c7c9299fe96?auto=format&fit=crop&w=800&q=80",
    description: "Built for high-altitude Khunjerab, Babusar, and Skardu trips. Thinsulate thermal insulation with Hipora waterproof breathable liner.",
  ...
  {
    id: "nm-08", name: "MotoMesh Pro V6 Bluetooth Intercom System (Twin Pack)", category: "helmets", categoryLabel: "Helmets & Tech",
    price: 28000, rating: 4.9, reviewsCount: 43, badge: "Mesh 2.0", badgeColor: "bg-indigo-600",
    ...
    sizes: ["Dual Pack (2 Units)", "Single Unit (₨ 15,000)"], inStock: true
  },
  {
    id: "nm-09", name: "Nova Moto Anti-Vibration Wireless Charging Phone Mount", category: "protection", categoryLabel: "Protection & Mounts",
    price: 7900, rating: 4.9, reviewsCount: 89, badge: "Smart QI 15W", badgeColor: "bg-cyan-600",
    ...
    sizes: ["Standard Handlebar Mount", "Mirror Stem Mount"], inStock: true
  },
  {
    id: "nm-10", name: "Enduro Magnetic & Strap Quick-Release Tank Bag 18L", category: "luggage", categoryLabel: "Touring Luggage",
    price: 9500, rating: 4.7, reviewsCount: 36, badge: "Quick Release", badgeColor: "bg-slate-700",
    image: "https://images.unsplash.com/photo-1609630875171-b1321377ee65?auto=format&fit=crop&w=800&q=80",
    description: "Versatile modular tank bag with sensitive touch-screen window for navigation tablets or smartphones. Expandable gusset adds 6L extra capacity.",
    ...
    sizes: ["18L Expandable"], inStock: true
  },
  {
    id: "nm-11", name: "Ultra-Beam 60W CREE Adventure Auxiliary Fog Lights (Pair)", category: "protection", categoryLabel: "Protection & Mounts",
    price: 16500, rating: 5.0, reviewsCount: 77, badge: "6000 Lumens", badgeColor: "bg-amber-600",
    image: "https://images.unsplash.com/photo-1487800940032-1cf21118ccde?auto=format&fit=crop&w=800&q=80",
    ...
    sizes: ["Crash Bar Mount (22mm-28mm)", "Fork Mount Clamps"], inStock: true
  },
  {
    id: "nm-12", name: "Nova Moto 45L Adventure Top Box w/ Passenger Backrest", category: "luggage", categoryLabel: "Touring Luggage",
    price: 38000, rating: 4.8, reviewsCount: 22, badge: "Helmet Fit", badgeColor: "bg-blue-600",
    image: "https://images.unsplash.com/photo-1622185135505-2d795043df06?auto=format&fit=crop&w=800&q=80",
    ...
    sizes: ["45 Liters Matte Black", "45 Liters Raw Aluminum"], inStock: true
  }
];

let cart = JSON.parse(localStorage.getItem("nova_moto_cart") || "[]");
function formatPKR(amount) { return "₨ " + amount.toLocaleString("en-PK"); }

let activeCategory = "all", searchQuery = "", sortBy = "featured";
...
function renderProducts() {
  ...
  if (filtered.length === 0) {
    container.innerHTML = `<div class="col-span-full py-16 text-center text-slate-400">
      ...
      <button onclick="resetFilters()" class="mt-4 px-5 py-2.5 bg-blue-600 hover:bg-blue-500 text-white rounded-lg text-sm font-semibold transition">Clear Filters</button>
    </div>`;
    lucide.createIcons();
    return;
  }
  ...
  container.innerHTML = filtered.map(product => {
    ...
    return `<div class="glass-card rounded-2xl overflow-hidden flex flex-col group border border-slate-800 hover:border-sky-500/40 transition duration-300">
      <div class="relative overflow-hidden aspect-[4/3] bg-slate-900">
        <img src="${product.image}" alt="${product.name}" class="w-full h-full object-cover group-hover:scale-105 transition-transform duration-500" loading="lazy" onerror="this.src='${FALLBACK_IMAGE}'" />
        <div class="absolute inset-0 bg-gradient-to-t from-slate-950 via-transparent to-transparent opacity-80"></div>
        <span class="absolute top-3 left-3 px-2.5 py-1 text-xs font-bold uppercase tracking-wider text-white rounded-md shadow-md ${product.badgeColor}">${product.badge}</span>
        ...
        <div>
          <div class="flex items-center justify-between text-xs text-sky-400 font-medium mb-1.5">
            ...
            <div class="flex items-center gap-1 text-amber-400 font-semibold">
              <i data-lucide="star" class="w-3.5 h-3.5 fill-current"></i><span>${product.rating}</span><span class="text-slate-500">(${product.reviewsCount})</span>
            </div>
          </div>
          <h3 class="font-bold text-white text-base leading-snug group-hover:text-sky-400 transition mb-2">${product.name}</h3>
...
function resetFilters() {
  ...
  document.querySelectorAll(".category-btn").forEach(btn => {
    btn.className = btn.dataset.category === "all" 
      ? "category-btn px-4 py-2 rounded-xl text-xs sm:text-sm font-semibold whitespace-nowrap transition bg-blue-600 text-white shadow-lg shadow-blue-500/25"
      : "category-btn px-4 py-2 rounded-xl text-xs sm:text-sm font-semibold whitespace-nowrap transition bg-slate-800/80 hover:bg-slate-700 text-slate-300 border border-slate-700/60";
  });
  renderProducts();
}
...
let currentQuickViewProduct = null, selectedModalSize = "";
...
function openQuickView(productId) {
  ...
  modalContent.innerHTML = `<div class="grid md:grid-cols-2 gap-6 p-6 sm:p-8">
    <div class="relative rounded-2xl overflow-hidden bg-slate-900 border border-slate-800 flex items-center justify-center">
      <img src="${p.image}" alt="${p.name}" class="w-full h-full object-cover max-h-[380px]" onerror="this.src='${FALLBACK_IMAGE}'" />
      <span class="absolute top-4 left-4 px-3 py-1 text-xs font-bold uppercase rounded-md text-white ${p.badgeColor}">${p.badge}</span>
    </div>
    <div class="flex flex-col justify-between">
      <div>
        <div class="flex items-center justify-between text-xs text-sky-400 font-medium mb-1">
          <span>${p.categoryLabel}</span>
          <span class="text-emerald-400 flex items-center gap-1 font-semibold"><i data-lucide="check-circle" class="w-3.5 h-3.5"></i> In Stock</span>
        </div>
        <h2 class="text-2xl font-black text-white leading-tight mb-2">${p.name}</h2>
        <div class="flex items-center gap-2 mb-4">
          <div class="flex items-center text-amber-400 text-sm"><i data-lucide="star" class="w-4 h-4 fill-current"></i><span class="font-bold ml-1">${p.rating}</span></div>
          <span class="text-slate-500 text-xs">| ${p.reviewsCount} verified rider reviews</span>
        </div>
        <div class="text-3xl font-extrabold text-white mb-4">${formatPKR(p.price)}</div>
        <p class="text-sm text-slate-300 leading-relaxed mb-5">${p.description}</p>
        <div class="mb-5">
          <h4 class="text-xs uppercase font-bold tracking-wider text-slate-400 mb-2">Key Technical Specs:</h4>
          <ul class="space-y-1.5 text-xs text-slate-300">
            ${p.features.map(f => `<li class="flex items-center gap-2"><i data-lucide="shield-check" class="w-4 h-4 text-sky-400 flex-shrink-0"></i><span>${f}</span></li>`).join("")}
          </ul>
        </div>
        <div class="mb-6">
          <label class="block text-xs uppercase font-bold tracking-wider text-slate-400 mb-2">Select Size / Option:</label>
          <div class="flex flex-wrap gap-2" id="modal-size-selector">
            ${p.sizes.map((s, idx) => `<button type="button" onclick="selectModalSize(this, '${s}')" class="size-opt-btn px-3 py-1.5 rounded-lg text-xs font-semibold border transition ${idx === 0 ? 'bg-sky-600 border-sky-500 text-white' : 'bg-slate-800 border-slate-700 text-slate-300 hover:border-slate-500'}">${s}</button>`).join("")}
          </div>
        </div>
      </div>
...
function addToCart(productId, size = null) {
  ...
  else cart.push({ id: p.id, name: p.name, price: p.price, image: p.image, size: chosenSize, quantity: 1 });
...
function removeCartItem(index) {
  if (!cart[index]) return;
  cart.splice(index, 1); saveCart(); updateCartUI();
...
function saveCart() { localStorage.setItem("nova_moto_cart", JSON.stringify(cart)); }
...
function updateCartUI() {
  ...
  cartList.innerHTML = cart.map((item, idx) => `
    <div class="flex items-center gap-3 p-3 bg-slate-900/80 rounded-xl border border-slate-800">
      <img src="${item.image}" alt="${item.name}" class="w-16 h-16 object-cover rounded-lg border border-slate-700/60" onerror="this.src='${FALLBACK_IMAGE}'" />
      ...
      <div class="flex flex-col items-end gap-2">
        <button onclick="removeCartItem(${idx})" class="text-slate-500 hover:text-red-400 transition"><i data-lucide="trash-2" class="w-3.5 h-3.5"></i></button>
...
function checkoutViaWhatsApp() {
  if (cart.length === 0) { showToast("Your cart is empty! Add gear before checking out."); return; }
  const subtotal = cart.reduce((sum, item) => sum + (item.price * item.quantity), 0);
  ...
  message += `━━━━━━━━━━━━━━━━━━━━\n*ESTIMATED TOTAL: ${formatPKR(subtotal)}*\n━━━━━━━━━━━━━━━━━━━━\nPlease confirm availability, dispatch timeframe, and payment instructions.`;
...
function showToast(message) {
  ...
  toast.innerHTML = `<i data-lucide="check-circle-2" class="w-5 h-5 text-sky-400 flex-shrink-0"></i><span>${message}</span>`;
  container.appendChild(toast);
  lucide.createIcons();
  setTimeout(() => {
    toast.style.opacity = "0"; toast.style.transform = "translateY(-10px)"; toast.style.transition = "all 0.3s ease-out";
...
function renderChecklist(presetKey = "kkh") {
  ...
  document.querySelectorAll(".preset-tab").forEach(tab => {
    tab.className = tab.dataset.preset === presetKey 
      ? "preset-tab px-4 py-2 bg-blue-600 text-white rounded-xl text-xs sm:text-sm font-bold shadow-lg shadow-blue-600/30"
      : "preset-tab px-4 py-2 bg-slate-800/80 hover:bg-slate-700 text-slate-300 rounded-xl text-xs sm:text-sm font-semibold border border-slate-700/60";
  });
  lucide.createIcons();
}
...
function addAllUncheckedToChecklistCart() {
  ...
  let addedCount = 0;
  items.forEach(it => {
    if (!it.checked) { addToCart(it.productId); it.checked = true; addedCount++; }
  });
  if (addedCount > 0) {
...
document.addEventListener("DOMContentLoaded", () => {
  renderProducts(); updateCartUI(); renderChecklist("kkh");
  ...
  if (sortSelect) sortSelect.addEventListener("change", (e) => { sortBy = e.target.value; renderProducts(); });
